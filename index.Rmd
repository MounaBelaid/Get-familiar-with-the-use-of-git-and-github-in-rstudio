...
5) Practice a set of tasks to get familiar with Git and GitHub in RStudio

6) Submission of a new Cheatsheet to the ["Cheatsheets" GitHub Repository](https://github.com/rstudio/cheatsheets) maintained by RStudio
]
...
.pull-left[- Clone a GitHub repository on your own machine
             
- Fork a GitHub repository
             
- Create a branch on GitHub using Git
             
- Open a pull request]
             
.pull-right[- Respond to a review
             
- Merge your pull request
             
- Explore the following commands: `git init`, `git clone`, `git config`, `git add`, `git status`, `git commit`, `git push`, `git pull`, `git branch`, and `git merge`]
]<!---->
...
- Find interesting Open Source projects to work on
...
`r icons::icon_style(icons::fontawesome("check-square"), scale = 3, fill = "white")`
# Let's master fundamentals on GitHub!
...
.left-column[
## Activity<br>`r icons::fontawesome("edit")`<br>
### 10:00 mins
]
...
----
.my-white[
1. Create a branch in the repository that you've created [earlier](#repository)
2. Make changes to this repository
3. Commit and push your changes to your branch
4. Create a pull request to ask collaborators for feedback on your changes
