---
title: "Getting Familiar with Git & GitHub in RStudio"
author: "Mouna Belaid"
...
meta() %>%
  ...
  meta_name("github-repo" = "MounaBelaid/Get-familiar-with-the-use-of-git-and-github-in-rstudio") %>% 
  meta_social(
    title = "Getting familiar with the use of Git & GitHub in RStudio",
    url = "https://mounabelaid.github.io/Get-familiar-with-the-use-of-git-and-github-in-rstudio",
    image = "",
    image_alt = paste(
...
background-image: url(img/git_github.png), url(img/Oman_Abuja_logos.png)
...
### Business Intelligence Consultant<br>Prime Analytics - Tunis, Tunisia<br>Organizer at R-Ladies Paris
...
As ….. introduced me. I'm Mouna BELAID and I'm a Business Intelligence Consultant at Prime Analytics and Organizer of R-Ladies Paris

---
layout: true

<a class="footer-link" href="https://bit.ly/3B7km3p">bit.ly/3B7km3p &mdash; Mouna Belaid</a>
...
So what's about the session outline ?
I will start giving an overview of ……..
This session is intended to be interactive that's why we will practice a set of tasks to get familiar with Git and GitHub in RStudio
First you will learn about GitHub fundamentals then we will move to some practices.
...
You need to have a GitHub account and Git installed before moving on. 
...
Version control, also known as source control, is the practice of tracking and managing changes to software code.
The code for a project, application or software component is typically organized in a folder structure.
Version control helps tracking every individual change in the code by each contributor and helping prevent concurrent work from conflicting.
You know! As development environments have accelerated, version control systems will help software teams work faster and smarter.

Version control will help you streamline your work because it takes care of otherwise time-consuming bookkeeping and unrelenting file tracking. 
Instead of spending our time inspecting and fretting over whether “analysis_final_v2.xls” or “analysis_final_final.xls” is truly the final version, with a version control tool we can be confident in our completed analysis and move to the next step.

On this context, I want to tell you about an illustrated series that has been recenty created by Allison Horst and Julia Stewart Lowndes. The figure that you are looking at and which I find so insightful :D is one of the amazing illustrations that tell a story about why GitHub is so powerful for supporting, reusing, contributing, and failing safely. I will share with you now in the chat link (https://www.openscapes.org/blog/2022/05/27/github-illustrated-series/)  so that you get to know more later about this amazing work. There are really other amazing illustrations.
Version Control will also enable you to make your work more reproducible. Using version control for your research project means that your work is totally transparent, and because all your actions are recorded, it enables others to reproduce your studies.

As you can see, there are many choices, but here we are going to focus on just one, Git.
So we have SVN, or Subversion…
...
Git is distributed version control software. Git manages the evolution of a set of files – called a repository – in a sane, highly structured way.
Being distributed means that every developer working with a Git repository has a copy of that entire repository - every commit, every branch, every file. It was originally developed in 2005 by Linus Torvalds, the creator of the Linux operating system kernel
...
What's GitHub?
GitHub is a collaboration platform.  It is the most popular hosting service for collaborating on code using Git. Other hosting services include Bitbucket, and Gitlab.
...
This is a second illustration from the GitHub illustration series that I've talked about to you earlier. 
Collaboration…..
